...
const HELP_CENTER_URL = "https://www.doubleadigitalsolutions.store/pospro/help-center";
...
/** Public Help Center page — no auth/cookie bootstrap needed (unlike AdminWebView), same shape as FaqScreen. */
export default function HelpCenterScreen() {
  ...
  if (error) {
    return (
      ...
      >
        <Text style={styles.subheading}>Could not load the Help Center</Text>
  ...
  return (
    <View style={{ flex: 1, backgroundColor: color.surface }}>
      {!ready ? <LoadingState text="Opening Help Center…" /> : null}
      <WebView
        key={attempt}
        ...
        onError={(event: WebViewErrorEvent) => {
          ...
          setError(description || "Could not reach the Help Center.");
        }}
