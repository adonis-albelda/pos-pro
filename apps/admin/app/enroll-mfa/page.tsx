...
/** Server Component shell — same reason as change-password/page.tsx. Form stays client (useMutation + mfa API). */
      ...
      <div className="relative flex flex-1 items-center justify-center overflow-hidden bg-paper px-6 py-12 lg:w-[45%] lg:flex-none">
        ...
        <div className="relative w-full max-w-sm">
          ...
          <div className="rounded-2xl border border-border/60 bg-surface p-8 shadow-lg shadow-ink/5">
            <h2 className="text-heading-lg font-bold text-ink">Set up two-factor authentication</h2>
            <p className="mt-2 text-body text-ink-muted">
              Your account requires an authenticator app before you can use the dashboard.
            </p>
